...
Currently supporting the Garmin Instinct 2 and Garmin Instinct 3 45mm.

The watchface can display the following fields:
...
Options like temperature and 24 vs 12 hour preference are taken from your Garmin device settings. Other preferences are managed in ConnectIQ after you install the watchface.
